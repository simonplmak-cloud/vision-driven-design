...
| A-038 | Build VDD universal access layer — MCP server (14 tools), CLI binary (`vdd`), shared engine module, npm-publishable package | MUST 🚧 IN PROGRESS (9/12 tasks done, repo: simonplmak-cloud/vdd-access) | P12 (Universal Access), P7 (Agent Integration) | L | A-019, A-023 |
