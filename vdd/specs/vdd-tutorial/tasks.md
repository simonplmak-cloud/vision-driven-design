...
- [x] **TASK-001** [S] Create directory and scaffold tutorial file
  - Creates: `vdd/docs/tutorial.md` with placeholder sections
  - Depends on: none

### Content

- [x] **TASK-002** [M] [P] Write Phase 0-2 sections (Constitution, Vision, Strategy)
